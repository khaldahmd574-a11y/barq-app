...
# =========================================================
# PURE INTENT AI ANALYSIS ENGINE (تحليل الدور والنية المتقدم)
# =========================================================
...
1. الأسئلة والاستفسارات عن توفر سائق أو خط سير (مثل: "مين طالع من صبيا للخميس؟"، "فيه أحد رايح جازان؟"، "مين فاضي يوصل؟").
...
* قاعدة حاسمة: لو كان النص يحتوي على صيغة سؤال/استفسار أو طلب احتياج (مين/فيه/ابغى/محتاج/أبي/مطلوب) $\leftarrow$ أجب بـ (YES) فوراً، حتى لو تشابهت الكلمات مع السائقين.
...
1. التصريح بالتحرك أو الجاهزية الشخصية للعامة (مثل: "متحرك من صبياء"، "مشي العصر ركاب او رسائل"، "أنا فاضي"، "متواجد حالياً"، "طالع جازان اللي يبي يكلمني").
2. السائق الذي يعرض خدمة التوصيل للدوامات أو المجموعات ويتلقى الطلبات (مثل: "لو فيه مجموعة يبون سواق دوامات يراسلوني").
3. إعلانات قوائم الخدمات المكررة، أرقام التواصل في إعلانات السائقين، والوظائف والعملات الرقمية.
