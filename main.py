...
# عبارات تدل أن الكاتب سائق/مندوب يتم استبعادها فوراً
DRIVER_PATTERNS = [
    ...
    "مين يبغى", "سيارة خاصة", "سياره خاصه", "موجود للتوصيل", "حاضر للتوصيل",
    "جاهز للتوصيل", "تواصل خاص", "تواصلوا خاص", "ارسل خاص", "أرسل خاص"
]
...
def is_customer_request(text):
    ...
    # 2. قبول العبارات المباشرة القصيرة (مثل: مشوار صامطة / توصيل ضمد)
    if any(k in norm_text for k in ["مشوار", "توصيل", "توصيله", "توصيلة"]):
        return True

    # 3. التأكد من وجود فعل تنقل أو نية طلب من القائمة الشاملة
